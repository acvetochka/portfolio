...
import { DescriptionWrapper, TechnologiesList } from "./ProjectDescription.styles";
import { ProjectDescriptionProps } from "./ProjectDescription.props";
// import { Tag } from "../Tag/Tag";


export const ProjectDescription = ({role, description, technologies}:ProjectDescriptionProps):JSX.Element => {
    return (
